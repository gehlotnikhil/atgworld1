  ...
  return (
    ...
    <div className='leftPost' style={{marginTop:"1rem", width: "70%" }}>
                    <div className="card left-1" style={{ width: "70%", margin: "0 15%" }} >
                        <img  alt="..." src="../images/forest.png" className="card-img-top"  />
                        <div className="card-body">
                            <div style={{ margin: "0" }}><img  alt="..." src="../images/article2.png" style={{ height: "20px", marginBottom: "3px" }} /> Article</div>
                            ...
                            <div className="card-text d-flex bd-highlight  ">
                                <div className='me-auto p-2 bd-highlight' style={{ display: "flex", flexDirection: "row" }}>
                                    <img  alt="..." src="../images/person1_1.png" style={{ height: "50px" }}  srcSet="" />
                                ...
                                <div className='p-2 bd-highlight' style={{ display: "flex", flexDirection: "row" }}>
                                    <div style={{ marginBottom: "0", marginTop: "12px" }}><img  alt="..." src='../images/eye.png' style={{ height: "25px" }} />1.4k views</div>
                                    <img  alt="..." src="../images/share.png" style={{ height: "25px", marginBottom: "0", marginTop: "12px", marginLeft: "40px" }}  />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="card left-1" style={{  width: "70%", margin: "0 15%", marginTop:"1rem" }} >
                        <img  alt="..." src="../images/rust.png" className="card-img-top"  />
                        <div className="card-body">
                            <div style={{ margin: "0" }}><img  alt="..." src="../images/education_logo.png" style={{ height: "20px", marginBottom: "3px" }} /> Education</div>
                            ...
                            <div className="card-text d-flex bd-highlight  ">
                                <div className='me-auto p-2 bd-highlight' style={{ display: "flex", flexDirection: "row" }}>
                                    <img  alt="..." src="../images/person2.png" style={{ height: "50px" }}  srcSet="" />
                    ...
                    <div className="card left-1" style={{  width: "70%", margin: "0 15%" , marginTop:"1rem"}} >
                        <img  alt="..." src="../images/car.png" className="card-img-top"  />
                        <div className="card-body">
                            <div style={{ margin: "0" }}><img  alt="..." src="../images/meetup_logo.png" style={{ height: "20px", marginBottom: "3px" }} /> Meetup</div>
                            ...
                            <div className='d-flex mb-3'>
                                <span className='me-auto p-2'><span><img  alt="..." style={{height:"25px"}} src="../images/calendar.png"  /></span> Fri, 12 Oct, 2018</span>
                                <span className=' p-2'><span><img  alt="..." style={{height:"25px"}} src="../images/location2.png"  /></span> Ahmedabad, India</span>
                            </div>
